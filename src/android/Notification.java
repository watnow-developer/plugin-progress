...
public class Notification extends CordovaPlugin {
	...
	public boolean execute(String action, JSONArray args,
		...
		if (action.equals("beep")) {
			...
			this.prompt(args.getString(0), args.getString(1),
					args.getJSONArray(2), args.getString(3), type,
					callbackContext);
			return true;
		} else if (action.equals("activityStart")) {
			this.activityStart(args.getString(0), args.getString(1));
		} else if (action.equals("activityChangeMessage")) {
			this.activityChangeMessage(args.getString(0));
	...
	public void beep(final long count) {
		cordova.getThreadPool().execute(new Runnable() {
			public void run() {
				...
				Ringtone notification = RingtoneManager.getRingtone(cordova
	...
	public synchronized void alert(final String message, final String title,
		...
		Runnable runnable = new Runnable() {
			public void run() {
				...
				AlertDialog.Builder dlg = createDialog(cordova); // new
	...
	public synchronized void prompt(final String message, final String title,
			...
			final String dialogType, final CallbackContext callbackContext) {
	 ...
	 */
	public synchronized void activityChangeMessage(final String message) {
		if (this.spinnerDialog != null) {
			final Notification notification = this;
			Runnable runnable = new Runnable() {
				public void run() {
	 ...
	 *            The callback context
	 */
	public synchronized void list(final String title, final JSONArray data,
	...
	private void changeTextDirection(Builder dlg) {
		...
		if (currentapiVersion >= android.os.Build.VERSION_CODES.JELLY_BEAN_MR1) {
			...
			if (messageview != null)
				messageview
						.setTextDirection(android.view.View.TEXT_DIRECTION_LOCALE);
		}
	}
}
